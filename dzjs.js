...
function s10(text, age) {
    console.log(arguments);
}

s10('text', 24);
// слово arguments означает аргументы функции.
...
persona15.firstFunc.apply(personb1)
...
//1, 2, 3
 с помощью Math.max() если это просто числа и Math.max.apply('null', ) если это массив.

// 18)
//с помощью какого метода можно вывести максимально большое число из массива
//[1, 2, 4]
 с помощью Math.max.apply - Math.max.apply('null', [1, 2, 4])

// 19)
//с помощью какого метода можно вывести самое маленькое число из списка
//1, 2, 3
 с помощью Math.min() если это просто числа и Math.min.apply('null', ) если это массив.

// 20)
//с помощью какого метода можно вывести маленькое число из массива
//[1, 2, 4]
 с помощью Math.min.apply - Math.min.apply(